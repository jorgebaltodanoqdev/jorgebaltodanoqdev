...
var runningTotal = 0; // Resultado final

var buffer = "0"; //valor memoria

var previousOperator; //

var screen = document.querySelector(".calc-screen"); //Detectar disparo evento
...
init(); //Muestra caracter pantalla
...
function handleMath(value) {
  ...
  var numberBuffer = parseInt(buffer);
